...
export default async function AdminProtectedLayout({
  ...
  return (
    <div className="min-h-screen bg-[rgb(250,248,242)]">
      <div className="mx-auto w-full max-w-6xl px-3 sm:px-6 py-6">
        {/* MOBILE */}
        ...
        <div className="grid gap-4 md:grid-cols-[240px_1fr]">
          ...
          {/* IMPORTANT: min-w-0 evita shrink strani */}
          <main className="min-w-0 rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-4 sm:p-6">
            {children}
          </main>
        </div>
      </div>
